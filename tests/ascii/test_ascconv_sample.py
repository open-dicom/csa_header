...
from csa_header.ascii.ascconv import (
    AscconvParseError,
    assign_to_atoms,
    obj_from_atoms,
    parse_ascconv,
...
from tests.ascii.fixtures import TEST_ASCCONV_FILE


def test_ascconv_parse():
    with open(TEST_ASCCONV_FILE) as fobj:
        contents = fobj.read()
...
def atom_seq_same(seq1, seq2):
    ...
    for a1, a2 in zip(seq1, seq2):
        if not isinstance(a1[0], type(a2[0])) or a1[1] != a2[1] or a1[2] != a2[2]:
            return False
    return True
